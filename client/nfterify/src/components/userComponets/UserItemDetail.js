...
const  UserItemDetail = () =>  {
   ...
   // let itemData = Array.from(GetItems(user.userRole,user.userInfoID));
    ...
    console.log('usrl ' + baseurl+'/getUserDetails/'+userDetailId );
    let one =baseurl+'/getUserDetails/'+userDetailId
    ...
    function setShowModalCode(statusIN) {
        ...
        if (statusIN == "xsmall"){
            ...
            console.log("THIS IS THE SIZE sizeobejct size " +JSON.stringify(sizeObject))
    ...
    return(
        <div className="bg-slate-50">
            <div className="flex ">
                    <div>
                        <Link className="px-10 mx-10" to={"/"}> <FaArrowCircleLeft size={40} /> </Link>
                    </div>
                    <div>
                        {/*//<img className=" " src={item.image} alt="display "/>*/}
                            ...
                            <div className="bg-white rounded-lg shadow-lg">
                                ...
                                <img
                                    ...
                                    <div className="p-6">
                                        <h2 className="font-bold content-center mb-2 text-2xl text-purple-800">{item.name}
                                        </h2>
                                        <h4 className="py-3"><span className="font-bold">Brand:  </span>  {item.brandName}</h4>
                                        <h4 className="py-3">Collection Name  : {item.collectionName}</h4>
                                        <h4 className="break-words py-3 text-overflow"> Description {item.description}</h4>
                                    </div>
                    ...
                    <div>
                        ...
                        <table className="table-fixed py-15">
                            <thead className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                            <tr>
                                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Sizes</th>
                                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Total Created</th>
                                <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Item Mint Details</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr className="px-5 py-3 border-b-2">
